...
export default async function ReceiptPage({
  ...
  // Receipt not in DB and no ?d= param — render client component that checks sessionStorage.
  // If sessionStorage has the receipt (same browser session), it auto-redirects with ?d=.
  if (!receipt) return <ReceiptFallback id={id} />
